	...
	const questionsAnswers = [
		...
		},
		{
			...
			answer: (
				<div>
					<p className="desktop-font line-height p-bottom-margin">
						Во-первых, вы сможете задать вопросы и пообщаться по
						теме с лучшими экспертами по эпохе Эдо в России.
					</p>
					<p className="desktop-font line-height p-bottom-margin">
						Во-вторых, интерактивный конкурс проходит в
						онлайн-формате. Отвечая на вопросы и выполняя квесты на
						сайте, вы можете выиграть замечательные призы.
					</p>
					<p className="desktop-font line-height p-bottom-margin">
						В третьих, только участники онлайн-лектория будут
						приглашены на очную встречу по итогам проведённого
						события. На собрании с презентациями выступят
						японистические проекты, а также будут вручены призы за
						победу в конкурсе.
					</p>
				</div>
			),
			...
			answer: (
				<div>
					<p className="desktop-font line-height p-bottom-margin">
						...
						составе пассионарные студенты и школьники, готовые и
						шутку пошутить, и крупнейшее образовательное событие по
						Японии провести. Впервые собранная в 2019 году, наша
						команда в течение учебного года ведёт просветительские
		...
		},
		{
			...
			answer: (
				<div>
					<p className="desktop-font line-height p-bottom-margin">
						Всё просто! Вы регистрируетесь и проверяете почту, а
						28-29 ноября входите в аккаунт на сайте и подключаетесь
						к онлайн-лекциям. Отвечать на вопросы и решать квесты
						смогут только зарегистрированные пользователи, так что
						поспешите.
					</p>
				</div>
			),
